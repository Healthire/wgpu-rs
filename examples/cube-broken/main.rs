...
impl framework::Example for Example {
    ...
    fn render(
            ...
            device.create_command_encoder(&wgpu::CommandEncoderDescriptor { todo: 0 });
        {
            ...
            // swapping the order of these to set bind group 0 before 1 fixes this example
            rpass.set_bind_group(1, &self.frag_bind_group, &[]);
            rpass.set_bind_group(0, &self.vert_bind_group, &[]);
